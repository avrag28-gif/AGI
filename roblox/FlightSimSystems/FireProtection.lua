...
function FireProtection:Step(dt)
 ...
 for i=1,2 do
  ...
  d.Fire=d.Detector>=0.8 or ef.Fire==true or (fpFailures.Engines and fpFailures.Engines[i] and fpFailures.Engines[i].Fire==true); d.Warning=d.Fire or d.Overheat or f.FireTest
 ...
 a.Fire=a.Detector>=0.8 or apuFailure.Fire==true; a.Warning=a.Fire or a.Overheat or f.FireTest

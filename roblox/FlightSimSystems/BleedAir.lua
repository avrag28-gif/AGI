-- FlightSim bleed-air / pack availability model v0.2
...
function BleedAir:Step(dt)
 local x=self.state:Get(); local b=x.BleedAir or {}; local e1=x.Engines and x.Engines[1] or {}; local e2=x.Engines and x.Engines[2] or {}; local apu=x.APU or {}; local el=x.Electrical or {}; local failures=x.Failures or {}; local ef=failures.Engines or {}; local pf=failures.Pressurization or {}
 ...
 if x.Pressurization then
  ...
  x.Pressurization.BleedSource1=b.Engine1Source or b.APUSource
  x.Pressurization.BleedSource2=b.Engine2Source or b.APUSource

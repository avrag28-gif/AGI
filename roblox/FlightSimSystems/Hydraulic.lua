-- FlightSim hydraulic system v1.1
-- State contract: Hydraulic.A/B/Standby are structured hydraulic-system records.
-- The standby system is modeled as an electrically driven alternate source and is
-- demand-driven rather than continuously pressurizing with no consumer demand.
...
function Hydraulic:Step(dt)
 ...
 local standbyDemand=clamp(tonumber(raw.Standby) or 0,0,1)

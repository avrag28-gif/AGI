-- FlightSim hydraulic system v0.9
-- Simulation approximation of dual hydraulic pressure, electric backup and actuator demand.
-- FlightControls publishes FlightControlsA/B; Hydraulic owns the combined A/B demand outputs.
...
function Hydraulic:Step(dt)
 ...
 local demandA=clamp(controlA+gearA+brakeA,0,1); local demandB=clamp(controlB+gearB+brakeB,0,1)

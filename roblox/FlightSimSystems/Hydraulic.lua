-- FlightSim hydraulic system v0.6
...
function Hydraulic:Step(dt)
 ...
 local demandA=clamp(fc*0.50+gear*0.30+brakes*0.20,0,1); local demandB=clamp(fc*0.50+gear*0.30+brakes*0.20,0,1)
 ...
 hs.DemandBreakdown={FlightControls=fc,LandingGear=gear,Brakes=brakes,Total=raw.Total}

...
local function engineState()
	return {
		N1=0,N2=0,EGT=20,OilPressure=0,FuelFlow=0,Thrust=0,Running=false,
		Starter=false,FuelOn=false,Ignition=false,GeneratorAvailable=false,
		StartFailed=false,Reverse=false,Fire=false,Overheat=false,
		EEC={Powered=false,Channel="NONE",Fault=false,Alternate=false},
	}
end

local function hydraulicState()
	return {Pressure=0,Quantity=0,PumpDemand=0,ElectricPump=false,EnginePump=false,Available=false,Overheat=false}
end
...
function State.new()
	return setmetatable({
		...
		GearPosition={Nose=1,Left=1,Right=1},
		GearStatus={Nose=1,Left=1,Right=1,DownLocked=true,UpLocked=false,Transitioning=false,AlternateExtension=false,Warning=false},
		...
		Radios={COM1=118,COM2=121.5,NAV1=110,NAV2=112,ADF1=350,ADF2=400},
		Transponder={Code="2000",Mode="STBY",Ident=false,IdentRemaining=0},
		...
		MCP={Heading=0,Altitude=0,Speed=nil,VerticalSpeed=0,HeadingMode="HDG SEL",AltitudeMode="ALT",SpeedMode="SPD",BankLimit=25,FlightDirector=false},
		FMC={Page="IDENT",Scratchpad="",Origin=nil,Destination=nil,CruiseAltitude=nil,Route={},Active=false},

		Landing={Phase="GROUND",Touchdown=false,Takeoff=false,Flare=false,Rollout=false,WheelContact=false,TouchdownQuality="NONE",TouchdownEvent=false,BrakingActive=false,ReverseThrust=false,RolloutDistance=0,GoAround=false},
		FlapSystem={Command=0,Detent=0,Target=0,VFE=250,OverSpeed=false},
		...
		Failures={Fuel={LeftPump=false,CenterPump=false,RightPump=false,Crossfeed=false}},
		SystemHealth={Electrical=false,HydraulicA=false,HydraulicB=false,Fuel=true},
		...
		ATC={Facility="GROUND",Phase="COLD",Callsign="FLIGHT",Clearance=nil,PendingReadback=nil,LastMessage="",LastResult="",Squawk="2000",AssignedFrequency=121.7,AssignedRunway=nil,AssignedHeading=nil,AssignedAltitude=nil,AssignedSpeed=nil,ClearanceValid=false,ReadbackValid=false,Sequence=0},
		ATCDecision={Instruction="NONE",ConflictWith=nil,DistanceM=nil,VerticalSeparationFt=nil},
		TCAS={Powered=false,Advisories={},ClosestIntruder=nil,ClosestRangeM=nil,HighestLevel="NONE"},
	},State)
end

-- Boeing 737-800 NG authoritative aircraft state v3.7
...
function State.new()
	return setmetatable({
		...
		-- Weight & balance. Baseline 737-800 mixed-class OEW is from Boeing airport-planning data.
		WeightBalance={
			OperatingEmptyMassKg=41413,
			PayloadMassKg=0,
			FuelMassKg=0,
			ZeroFuelMassKg=41413,
			GrossMassKg=41413,
			CenterOfGravityPercentMAC=25,
			MaxTakeoffMassKg=79016,
			MaxLandingMassKg=66361,
			MaxZeroFuelMassKg=62732,
			MaxTaxiMassKg=79242,
			Overweight=false,
			TakeoffWeightLimited=false,
			LandingWeightLimited=false,
		},

-- FlightSim authoritative aircraft state v0.9
...
function State.new() return setmetatable({
 ...
 Gear={Nose=true,Left=true,Right=true},GearPosition={Nose=1,Left=1,Right=1},GearStatus={Nose=1,Left=1,Right=1,DownLocked=true,UpLocked=false,Transitioning=false},Brakes={Parking=true,BrakePressure=0},
 ...
 Navigation={Mode="HDG",ActiveWaypoint=1,Route={},DistanceToWaypoint=0,BearingToWaypoint=0,CrossTrackError=0,RouteComplete=false,CommandHeading=0,HeadingError=0,CommandAltitude=0,ApproachRunway=nil,ILS=nil,VOR=nil},
 ...
 VNAV={Mode="OFF",TargetAltitude=nil,VerticalSpeed=0,PathError=0},FMC={Page="IDENT",Scratchpad="",Origin=nil,Destination=nil,CruiseAltitude=nil,Route={},Active=false},
 Landing={Phase="GROUND",Touchdown=false,Takeoff=false,Flare=false,Rollout=false},Failures={}
 },State) end

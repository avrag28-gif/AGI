-- FlightSim flight dynamics foundation v0.5
...
function Physics:Step(dt)
	...
	local s=x.Surface or {}
	local e1=x.Engines[1]; local e2=x.Engines[2]
	local thrust=(e1.Thrust or 0)+(e2.Thrust or 0)

	-- Current Airspeed is the simulator's indicated-speed value in knots.
	-- Position/Velocity remain Roblox studs and studs/sec.
	...
	local gearDrag=gearDown and 0.18 or 0
	local brakePressure=((x.Brakes and x.Brakes.BrakePressure) or 0)
	local brakeDrag=brakePressure*0.8

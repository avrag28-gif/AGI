-- FlightSim aerodynamic / ground dynamics foundation v2.3
...
function Physics:Step(dt)
 ...
 if x.GroundContact then altitude=0 else altitude=clamp(altitude+x.VerticalSpeed*dt/60,0,Config.MaxAltitude) end

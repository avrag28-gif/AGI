...
function AircraftModelBinder:Step()
	for id,b in pairs(self.bindings) do
		...
		if not model or not model.Parent or not state then
			...
			model:SetAttribute("FlightSimMCPHeading",finite(mcp.Heading or ap.TargetHeading,0))
			model:SetAttribute("FlightSimMCPAltitude",finite(mcp.Altitude or ap.TargetAltitude,0))
			model:SetAttribute("FlightSimMCPSpeed",finite(mcp.Speed or ap.TargetSpeed,0))
			model:SetAttribute("FlightSimMCPVerticalSpeed",finite(mcp.VerticalSpeed or ap.TargetVerticalSpeed,0))
			model:SetAttribute("FlightSimMCPHeadingMode",tostring(mcp.HeadingMode or ap.Mode or "OFF"))
			model:SetAttribute("FlightSimMCPAltitudeMode",tostring(mcp.AltitudeMode or ap.Mode or "OFF"))
			model:SetAttribute("FlightSimMCPVerticalSpeedMode",tostring(mcp.VerticalSpeedMode or ap.Mode or "OFF"))
			...
			model:SetAttribute("FlightSimMCPVerticalSpeed",finite(ap.TargetVerticalSpeed,0))

...
function APU:Step(dt)
 ...
 local a=x.APU
 local requested=e.APU==true and f.APU~=true
 local startPower=(e.Battery==true or e.ExternalPower==true or a.RPM>5) and f.APU~=true
 a.StartFailed=false
 ...
 elseif requested and not startPower then
  a.StartFailed=true; a.Starter=false; a.Running=false; a.RPM=clamp(a.RPM-30*dt,0,100)
 else
 ...
 a.GeneratorAvailable=a.Running and f.APU~=true

-- FlightSim VNAV waypoint-transition tests v0.6
...
local function run()
 local s=state({Altitude=30000,Airspeed=220,Autopilot={TargetAltitude=30000,TargetSpeed=220},Navigation={ActiveWaypoint=1,DistanceToWaypoint=200000,Route={
  ...
  {Ident="DES",Position=Vector3.new(800000,0,0),Altitude=12000,AltitudeConstraint="AT",Speed=180,SpeedConstraint="AT"},
 ...
 s.data.Navigation.DistanceToWaypoint=600000
 v:Step(1/60)
 ...
 s.data.Navigation.DistanceToWaypoint=400000
 v:Step(1/60)

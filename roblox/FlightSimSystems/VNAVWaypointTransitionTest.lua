-- FlightSim VNAV waypoint-transition tests v0.4
...
local function run()
 local s=state({Altitude=30000,Airspeed=220,Autopilot={TargetAltitude=30000,TargetSpeed=220},Navigation={ActiveWaypoint=1,DistanceToWaypoint=60000,Route={
  {Ident="CRZ1",Position=Vector3.zero,Altitude=30000,AltitudeConstraint="AT",Speed=250,SpeedConstraint="AT"},
  {Ident="CRZ2",Position=Vector3.new(60000,0,0),Altitude=30000,AltitudeConstraint="AT",Speed=230,SpeedConstraint="AT"},
  {Ident="DES",Position=Vector3.new(120000,0,0),Altitude=12000,AltitudeConstraint="AT",Speed=180,SpeedConstraint="AT"},

-- FlightSim modular runtime v0.9
...
local Navigation=require(systemsFolder:WaitForChild("Navigation")); local WaypointManager=require(systemsFolder:WaitForChild("WaypointManager")); local Autopilot=require(systemsFolder:WaitForChild("Autopilot")); local VNAV=require(systemsFolder:WaitForChild("VNAV")); local FMC=require(systemsFolder:WaitForChild("FMC")); local MCP=require(systemsFolder:WaitForChild("MCP")); local Physics=require(systemsFolder:WaitForChild("Physics")); local Trim=require(systemsFolder:WaitForChild("Trim"))
